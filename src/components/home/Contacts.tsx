function Contacts() {
  return (
    <section className="h-screen z-20 mb-10">
      <h1 className="uppercase text-4xl text-[#32495E] font-semibold lg:px-32 my-10">
        Контакты
      </h1>
      <iframe
        ...
        className="lg:px-32 w-full h-[70vh] "
        style={{ border: 0 }}
        allowFullScreen={true}
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade"
      ></iframe>
      <div className="flex lg:px-32 h-1/4 gap-10 pt-10 p-3">
        <div className="w-56">
          <p className="text-[#32495E] text-md lg:text-xl font-bold">
            Адреса компании
          </p>
          <p className="text-[#32495E] text-xs lg:text-md font-medium">
