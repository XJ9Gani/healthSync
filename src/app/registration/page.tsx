...
function Registration() {
  return (
    <section className=" lg:h-screen pt-32 bg-gradient-to-l from-[rgba(83,116,148,0.5)] to-[rgba(101,145,185,0.5)] pb-5 ">
      <div className="border w-11/12 lg:w-2/3 mx-auto rounded-lg shadow-[0_0_10px_1px_gray] bg-white">
